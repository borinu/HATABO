...
HATABO.CAROUSEL = {
	...
	rightSlide: function rightSlide() {
		var carouselOffsetLeft = this.$carouseImglList.offset().left;
	...
	autoLoop: function autoLoop() {
		...
		//やったこと
			//imgIndex・btnIndexにそれぞれのインデックス番号を取得して比べて・・的なことをしようとしたが、
			//undefaindになってしまう。し、やはりセットインターバルで選択中の画像のインデックスとくらべないと
			//連動させられない気がする。
			//var imgIndex = _self.getImgIndex();
			//var btnIndex = _self.getBtnIndex();
	...
	getImgIndex: function getImgIndex() {
		var _self = this;
	...
	getBtnIndex: function getBtnIndex() {
		var _self = this;
